...
public interface LibroService {
    ...
    /**
     * Servicio que devuelve la lista de libros disponibles para prestamo.
     *
    ...
    /**
     * Carga masivamente Libros.
     */
    LibroRs cargarLibrosDesdeCsv(MultipartFile archivo) throws BadRequestException;
}
