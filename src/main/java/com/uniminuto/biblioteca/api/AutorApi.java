...
public interface AutorApi {
        ...
        @RequestMapping(value = "/guardar-autor", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ResponseEntity<RespuestaGenericaRs> crearAutor(@RequestBody AutorRq AutorRq)
                        throws BadRequestException;

        @RequestMapping(value = "/actualizar-autor", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ResponseEntity<RespuestaGenericaRs> actualizarAutor(@RequestBody Autor autor)
                        throws BadRequestException;

        /**
         * Endpoint para guardar múltiples autores de forma masiva.
         * 
        ...
        @RequestMapping(value = "/cargar-masivo", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ResponseEntity<List<Autor>> cargarAutoresMasivo(
                        @RequestBody List<AutorRq> autores)
                        throws BadRequestException;
}