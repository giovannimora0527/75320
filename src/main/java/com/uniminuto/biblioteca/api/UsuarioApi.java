...
public interface UsuarioApi {
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/buscar-por-correo", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.GET)
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/guardar-usuario", produces = { "application/json" }, consumes = {
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/actualizar-usuario", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ...
        /**
         * Endpoint para guardar múltiples usuarios de forma masiva.
         * 
        ...
        @RequestMapping(value = "/cargar-masivo", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ResponseEntity<List<Usuario>> cargarUsuariosMasivo(
                        @RequestBody List<UsuarioRq> usuarios)
                        throws BadRequestException;
}