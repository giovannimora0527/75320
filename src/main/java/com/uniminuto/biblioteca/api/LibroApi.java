...
public interface LibroApi {
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/obtener-libro-nombre", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.GET)
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/obtener-libro-anio-publicacion", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.GET)
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/crear-libro", produces = { "application/json" }, consumes = {
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/listar-for-prestamo", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.GET)
         ...
         * @throws BadRequestException excepcion.
         */
        @RequestMapping(value = "/actualizar-libro", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ResponseEntity<RespuestaGenericaRs> actualizarLibro(@RequestBody Libro Libro)
                        throws BadRequestException;

        /**
         * Endpoint para guardar múltiples libros de forma masiva.
         * 
         ...
         */
        @RequestMapping(value = "/cargar-masivo", produces = { "application/json" }, consumes = {
                        "application/json" }, method = RequestMethod.POST)
        ResponseEntity<List<Libro>> cargarLibrosMasivo(
                        @RequestBody List<LibroRq> libros)
                        throws BadRequestException;
}